...
public class DbConexion {
    ...
    public Connection conectar(){
        ...
        try {
            ...
            con = DriverManager.getConnection("jdbc:mysql://localhost:3306/citasmedicas","root"," ");
        } catch (ClassNotFoundException | SQLException ex) {
            JOptionPane.showMessageDialog(null, "<html>Informacion<br>Falta la base de Datos CITASMEDICAS</html>","DSYSTEM",JOptionPane.INFORMATION_MESSAGE);
        }
        return con;
    }
